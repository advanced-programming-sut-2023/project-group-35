...
public enum BuildingType {
    ...
    MOVING_BRIDGE("movingBridge.png", Resource.WOOD, 10 , 0 , 1 , 100, 0, true), // پل متحرک
    LOOKOUT_TOWER("towers/lookoutTower.png", Resource.STONE, 10, 0 , 0 , 500, 0, false),
    PERIMETER_TOWER("towers/perimeterTower.png", Resource.STONE, 15 , 0 , 0 , 550, 0, false),
    ...
    ARMOURER("townBuildings/weaponBuildings/armourer.png", Resource.WOOD, 20 , 100 , 1, 120, 2, true),
    //WORKSHOP(),
    BARRACK("barrack.png", Resource.STONE, 15 , 0 , 0 , 250, 0, true), //سربازخانه
    MERCENARY_CAMP("militaryBuildings/mercenaryCamp.png", Resource.WOOD, 10 , 0 , 0 ,150, 0, true), // سرباز خانه مزدوران
    ENGINEER_GUILD("militaryBuildings/engineersGuild.png",Resource.WOOD, 10, 100 , 0 , 200, 0, true),
    ...
    IRON_MINE("industryBuildings/ironMine.png", Resource.WOOD, 20 , 0, 2, 200, 30, true),
    SHOP("market.png", Resource.WOOD, 5, 0 , 1 , 150, 0, true),
    ...
    FLETCHER("townBuildings/weaponBuildings/fletcher.png", Resource.WOOD, 20 , 100 ,1 , 200, 2, true),
    POLE_TURNER("townBuildings/weaponBuildings/poleTurner.png", Resource.WOOD, 10 , 100, 1 , 150, 2, true), // نیزه سازی
    OIL_SMELTER("townBuildings/Housing/oilSmelter.png", Resource.IRON, 100 , 0, 100 , 0, 0, false),
    CAGED_WAR_DOGS("dogCage.png", Resource.WOOD, 10, 0, 100, 0, 0, false),
    //SIEGE_TENT(),
