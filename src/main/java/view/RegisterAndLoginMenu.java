...
//                passwordField.setText(buildBulletString(password.length() + 1));
//                password += t1.charAt(password.length());
//            }
//        });
    ...
    public void showPasswordField(MouseEvent mouseEvent) {
        passwordField.setText("hello world");
    }

    public void showConfirmPasswordField(MouseEvent mouseEvent) {
    }
    ...
    public void setListenerForPasswordFields(PasswordField passwordField) {
